...
class DashboardEhs extends CI_Controller {
	...
	public function getJudgementValue(){
	    ...
	    $get   = $this->DashboardModelEhs->getJudgementVal($dateStart,$datefinish);
	...
	public function getStatusByPeople(){
	    ...
	    $get   = $this->DashboardModelEhs->getStatusByPeople($status,$people);
	...
	public function getPieValue(){
	    ...
	    $get   = $this->DashboardModelEhs->getPieValue($col,$dateStart,$datefinish);
