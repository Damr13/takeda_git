                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card" style="min-height: 484px;">
                                    <div class="card-header"><h3>Input New Line</h3></div>
                                    <div class="card-body">
                                        <form role="form" action="<?php echo base_url('MstLine/insert');?>" method="post">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">ID Line</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="lineName" placeholder="Line Name">
