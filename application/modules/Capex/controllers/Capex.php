...
class Capex extends CI_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('CapexModel','mdl');
		...
		$akses= $this->MenuModel->akses_menu2('Capex',$this->session->userdata('id_user_level'));
	...
	public function index(){	
		...
		$this->template->load('template','Capex',$data);
  ...
  //        </script>
	...
	public function update_fyb(){
		...
		$param = array('type' => $type, 'tahun' => $tahun, 'compare' => $compare);
	...
	public function excel(){
		...
		$this->load->view('Capex/Capex_excel',$data);
	...
	public function pdf(){
		...
		$this->load->view('Capex/Capex_pdf',$data);
