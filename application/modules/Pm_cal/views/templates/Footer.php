        ...
        <script>
            ...
            function cek()
            {
                ...
                if(tahun == '' || type_d == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Pm_cal/Pm_cal_cek') ?>',
                        type: "post",
            ...
            function reload_table()
            {
                ...
                if(tahun == '' || type_d == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Pm_cal/Pm_cal_table') ?>',
                        type: "post",
                        data: {tahun:tahun,type_d:type_d},
                        dataType: "JSON",
                        // beforeSend: function(){
                        ...
                        success : function(data){
                            // alert(data.respone);
                            if(data.respone=='sukses'){
                                if(type_d === "PM") $('#title').html("PREVENTIVE MAINTENANCE (EQUIPMENTS)");
                                if(type_d === "CAL") $('#title').html("CALIBRATION  (INSTRUMENT)");
                                $('#tahun_name').html('Year : '+data.tahun);
            ...
            function d_excel()
            {
                ...
                if(tahun == '' || type_d == ''){
                    ...
                    window.open('<?=site_url('Pm_cal')?>/excel?tahun='+tahun+'&type='+type_d, '_blank');
                }
            ...
            function d_pdf()
            {
                ...
                if(tahun == '' || type_d == ''){
                    ...
                    window.open('<?=site_url('Pm_cal')?>/pdf?tahun='+tahun+'&type='+type_d, '_blank');
                }
            ...
            function update(){
                ...
                if(val == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Pm_cal/update_det') ?>',
                        type: "post",
