        ...
        <script>
            ...
            function cek()
            {
                ...
                if(tahun == '' || type_d == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Consumption/cek') ?>',
                        type: "post",
            ...
            function reload_table()
            {
                ...
                if(tahun == '' || type_d == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Consumption/table') ?>',
                        type: "post",
                        data: {tahun:tahun,type_d:type_d},
                        dataType: "JSON",
                        // beforeSend: function(){
                        ...
                        success : function(data){
                            // alert(data.respone);
                            if(data.respone=='sukses'){
                                if(type_d === "CONS_CAR") $('#title').html("FUEL CONSUMPTION (LITERS)");
                                if(type_d === "CONS_WATER") $('#title').html("WATER CONSUMPTION (M3)");
                                if(type_d === "CONS_ELECTRICITY") $('#title').html("ELECTRICITY CONSUMPTION (KWH)");
                                $('#tahun_name').html('Year : '+data.tahun);
                                $('#titleChart').html('MONTHLY PERCENTAGE ('+data.tahun+')');
                                // $('#div_kanban_tabel').show();
                                $('#t_body').html(data.tabel);
                                //generate_data(data.line);
                                line_chart2(data.grp,data.unit);
            ...
            function d_excel()
            {
                ...
                if(tahun == '' || type_d == ''){
                    ...
                    window.open('<?=site_url('Consumption')?>/excel?tahun='+tahun+'&type='+type_d, '_blank');
                }
            ...
            function d_pdf()
            {
                ...
                if(tahun == '' || type_d == ''){
                    ...
                    window.open('<?=site_url('Consumption')?>/pdf?tahun='+tahun+'&type='+type_d, '_blank');
                }
            ...
            function update(){
                ...
                if(val == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Consumption/update_det') ?>',
                        type: "post",
