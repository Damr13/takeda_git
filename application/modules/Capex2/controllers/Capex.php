		...
		foreach ($data as $data) {
			...
			$tabel.= '
				<tr>
					...
					<td style="text-align:right !important">'.$this->format_angkat($data->fyb).'</td>
					<td style="text-align:right !important">'.$this->format_angkat($rm_budget).' &nbsp;&nbsp;'.$this->label_rm($rm_budget,$data->fyb).'</td>
