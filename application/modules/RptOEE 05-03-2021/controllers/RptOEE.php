...
class RptOEE extends CI_Controller {
	...
	public function RptOEE_table(){
		...
		$tabel.=$this->shift($bulan,$id_machine);
		$tabel.=$this->tanggal($bulan,$id_machine);
		$tabel.=$this->mesin($bulan,$id_machine);
		$tabel.=$this->produk($bulan,$id_machine);
		$tabel.=$this->operator($bulan,$id_machine);
		$tabel.=$this->plan_operating_time($bulan,$id_machine);
		$tabel.=$this->pdt($bulan,$id_machine);
		$tabel.=$this->updt($bulan,$id_machine);
		$tabel.=$this->idle($bulan,$id_machine);
		$tabel.=$this->utility($bulan,$id_machine);
		$tabel.=$this->machine_operating_time($bulan,$id_machine);
		$tabel.=$this->speed_ideal($bulan,$id_machine);
		$tabel.=$this->good_pieces($bulan,$id_machine);
		$tabel.=$this->reject($bulan,$id_machine);
		$tabel.=$this->total_output($bulan,$id_machine);
		$tabel.=$this->availability($bulan,$id_machine);
		$tabel.=$this->performance($bulan,$id_machine);
		$tabel.=$this->quality($bulan,$id_machine);
		$tabel.=$this->overall_oee($bulan,$id_machine);
		$tabel.=$this->target_oee($bulan,$id_machine);
		$tabel.=$this->freq_bd($bulan,$id_machine);
		$tabel.=$this->mtbf_min($bulan,$id_machine);
		$tabel.=$this->mttr_min($bulan,$id_machine);
		$tabel.=$this->availability2($bulan,$id_machine);
	...
	public function shift($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function tanggal($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function mesin($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function produk($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function operator($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function plan_operating_time($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function pdt($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function updt($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function idle($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function utility($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function machine_operating_time($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function speed_ideal($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function good_pieces($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function reject($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function total_output($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function availability($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function performance($bulan,$id_machine){
		$tabel="";
  ...
  //                   </tr>
	...
	public function quality($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function target_oee($bulan,$id_machine){
	...
	public function freq_bd($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function mtbf_min($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function mttr_min($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function availability2($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function mtbf_min_ytd($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function mttr_min_ytd($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
	...
	public function availability2_ytd($bulan,$id_machine){
		$tabel="";
		$tabel.= '
					<tr>
