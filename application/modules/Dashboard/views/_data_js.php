<script type="text/javascript">
  ...
  function changePeriodeProd(checkBy) {
    ...
    $.ajax({
      type: "POST",
    	url: '<?php echo base_url().'Dashboard/getTotProdCard/'; ?>',
  ...
  function changeMachine(checkBy) {
    ...
    // LOAD DATA MACHINE AVAILABILITY BASED ON MACHINE --ir 
	  $.ajax({
      type: "POST",
	  	url: '<?php echo base_url().'Dashboard/getMaValue/'; ?>',
  ...
  function line_chart(){
    ...
    if(id_machine){
      $.ajax({
        type: "POST",
        url: '<?php echo base_url().'Dashboard/g_oee/'; ?>',
  ...
  function calibration(checkBy){
    ...
    if(type){
      $.ajax({
        type: "POST",
        url: '<?php echo base_url().'Dashboard/pm_cal/'; ?>',
  ...
  function capa_qa(checkBy){
    ...
    if(type){
      $.ajax({
        type: "POST",
        url: '<?php echo base_url().'Dashboard/capa/'; ?>',
        data: {type:type, periode:periode, checkBy:checkBy},
        dataType: "json",
        success: function(data) {
          if(data.respone == 'sukses'){
  ...
  function cons_car(checkBy){
    ...
    if(type){
      $.ajax({
      type: "POST",
      url: '<?php echo base_url().'Dashboard/consumption/'; ?>',
      data: {type:type, periode:periode, checkBy:checkBy},
      dataType: "json",
      success: function(data) {
        if(data.respone == 'sukses'){
  ...
  function chart_capex(tahun,compare){
    ...
    $.ajax({
    type: "POST",
    url: '<?php echo base_url().'Dashboard/chart_budget'; ?>',
