      ...
      <div class="row align-items-end">
        <div class="col-lg-12">
          <div class="page-header-title" style="text-align: center;">
            ...
            <div class="d-inline">
              <h5>Opex In Million IDR <div id="tahun_name"></div> </h5>
              <hr />
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-12 row align-items-end" style="margin-bottom:10px;">
        ...
        <div class="col-lg-2" style="display: none;" id="div_fyb">
          <div class='form-group' style='width:100% !important'>
              ...
              <input id="fyb" name="fyb" class="form-control" onkeypress="return hanyaAngka(event)" readonly> 
          </div>
        </div>
        <div class="col-lg-2 pull-left" style="display: none;" id="div_btn_upd">
          <div class='form-group' style='width:100% !important; display:none'>
