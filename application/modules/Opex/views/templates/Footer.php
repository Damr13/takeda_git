        ...
        <script>
            ...
            function cek()
            {
                ...
                if(tahun == '' || compare == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Opex/cek') ?>',
                        type: "post",
            ...
            function reload_table()
            {
                ...
                if(tahun == '' || compare == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Opex/table') ?>',
                        type: "post",
                        data: {tahun:tahun,compare:compare},
                        dataType: "JSON",
                        // beforeSend: function(){
            ...
            function d_excel()
            {
                ...
                if(tahun == '' || compare == ''){
                    ...
                    window.open('<?=site_url('Opex')?>/excel?tahun='+tahun+'&compare='+compare, '_blank');
                }
            ...
            function d_pdf()
            {
                ...
                if(tahun == '' || compare == ''){
                    ...
                    window.open('<?=site_url('Opex')?>/pdf?tahun='+tahun+'&compare='+compare, '_blank');
                }
            ...
            function update(){
                ...
                if(val == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Opex/update_det') ?>',
                        type: "post",
            ...
            function upd_fyb(){
                ...
                if(tahun == '' || fyb == ''){
                    ...
                    $.ajax({
                        url : '<?php echo base_url('Opex/update_fyb') ?>',
                        type: "post",
