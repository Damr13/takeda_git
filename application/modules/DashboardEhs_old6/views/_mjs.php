...
$(document).ready(function() {
  percentageFGood = '<?php echo $percentageFGood; ?>';
  if(percentageFGood < 98) {
    ...
    var chart = AmCharts.makeChart("bar_chart", {
        ...
        "graphs": [{
            ...
            "fillAlphas": 0.5,
            "type": "column",
            "title": "Series Total Breakdown Point April",
            "valueField": "sales2",
            "columnWidth": 10,
            "legendValueText": "Value [[47.5]]",
            "balloonText": "[[title]]<br /><b style='font-size: 99%'>Value : 47.5</b>"
        }, {
            // "id": "g4",
            // "valueAxis": "v1",
            // "lineColor": "#2ed8b6",
    ...
    var chart = AmCharts.makeChart( "capa_chart", {
        ...
        var chart = AmCharts.makeChart( "breakdown_chart", {
        "type": "pie",
        "theme": "none",
        "legend":{
       	"position":"bottom",
