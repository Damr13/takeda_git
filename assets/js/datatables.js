$(document).ready(function() {
    ...
    $('#noSearch, #noSearch2, #noSearch3, #noSearch4').DataTable({
        searching: false,
    });
    $('#no-style').DataTable();
    $('#compact, #compact2').DataTable();
    ...
    $('#complex-dt, #finishedMonPart, #planMonPart, #finishedMpPart, #planMpPart').DataTable({
        "autoWidth": false,
        dom: 'Bfrtip',
        buttons: [
            'copyHtml5',
